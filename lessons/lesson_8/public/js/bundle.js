...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _someCalc__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./someCalc */ \"./application/command/someCalc.js\");\n/* harmony import */ var _exec__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./exec */ \"./application/command/exec.js\");\n/* harmony import */ var _undo__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./undo */ \"./application/command/undo.js\");\n/* harmony import */ var _inter__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./inter */ \"./application/command/inter.js\");\n/*\n  Command:\n  Команда — это поведенческий паттерн проектирования,\n  который превращает запросы в объекты, позволяя передавать их\n  как аргументы при вызове методов, ставить запросы в очередь,\n  логировать их, а также поддерживать отмену операций.\n\n*/\n\n\n\n\n\n\n\nconst Command = () => {\n\n  /*\n    1. Простой калькулятор\n  */\n  // SomeCalc();\n\n  /*\n    2. Калькулятор используя паттерн комманды\n  */\n  // ExecCalc();\n\n  /*\n    3. Калькулятор используя паттерн комманды и функцией undo\n  */\n  // UndoCalc();\n  /*\n    4. Interface\n  */\n  Object(_inter__WEBPACK_IMPORTED_MODULE_3__[\"default\"])();\n\n\n}\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (Command);\n\n\n//# sourceURL=webpack:///./application/command/index.js?");
...
/***/ "./application/command/someCalc.js":
/*!*****************************************!*\
  !*** ./application/command/someCalc.js ***!
  \*****************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\nconst someCalc = () => {\r\n\r\n  class Calc {\r\n    constructor(){\r\n      this.currentValue = 0;\r\n      this.history = [];\r\n    }\r\n    add( value ){\r\n      this.currentValue += value;\r\n      console.log('new value:', this.currentValue );\r\n    }\r\n    sub( value ){\r\n      this.currentValue -= value;\r\n      console.log('new value:', this.currentValue );\r\n    }\r\n    getCurrentValue(){\r\n      console.log('CurrentValue is:', this.currentValue);\r\n      return( this.currentValue );\r\n    }\r\n  }\r\n\r\n\r\n    const SuperCalc = new Calc();\r\n\r\n    SuperCalc.add(50);\r\n    SuperCalc.add(30);\r\n    SuperCalc.sub(3);\r\n    SuperCalc.getCurrentValue();\r\n\r\n}\r\n\r\n/* harmony default export */ __webpack_exports__[\"default\"] = (someCalc);\r\n\n\n//# sourceURL=webpack:///./application/command/someCalc.js?");
...
/*!*************************************!*\
  !*** ./application/command/undo.js ***!
  \*************************************/
/*! exports provided: Calc, Command, AddCommand, SubCommand, MultiplyCommand, DivideCommand, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _testing_func__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./testing-func */ \"./application/testing/testing-func.js\");\n/* harmony import */ var _testing_api_func__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./testing-api-func */ \"./application/testing/testing-api-func.js\");\n\r\n\r\n\r\nconst testingWrap = () => {\r\n\r\n    const cart = [\r\n      {\r\n        name: 'Magic beans',\r\n        price: 50\r\n      },\r\n      {\r\n        name: 'Broken Sword of dumbass',\r\n        price: 1\r\n      },\r\n      {\r\n        name: 'Justice fork',\r\n        price: 150\r\n      }\r\n    ];\r\n\r\n    const cart_quantity = [\r\n      {\r\n        name: 'Magic beans',\r\n        price: 50,\r\n        quantity: 10\r\n      },\r\n      {\r\n        name: 'Broken Sword of dumbass',\r\n        price: 1,\r\n        quantity: 1\r\n      },\r\n      {\r\n        name: 'Justice fork',\r\n        price: 150,\r\n        quantity: 2\r\n      }\r\n    ];\r\n\r\n    if(  Object(_testing_func__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(cart) !== 201 ){\r\n      throw new Error('Cart counting failed');\r\n    } else {\r\n      console.log('Cart counting passed ✅');\r\n    }\r\n\r\n    if(  Object(_testing_func__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(cart_quantity) !== 801 ){\r\n      throw new Error('Cart counting failed');\r\n    } else {\r\n      console.log('Cart counting passed ✅');\r\n    }\r\n\r\n    _testing_api_func__WEBPACK_IMPORTED_MODULE_1__[\"default\"].getRandomUsers().then( res => console.log( res[0].name) );\r\n\r\n\r\n\r\n\r\n}\r\n\r\n/* harmony default export */ __webpack_exports__[\"default\"] = (testingWrap);\r\n\n\n//# sourceURL=webpack:///./application/testing/index.js?");

/***/ }),

/***/ "./application/testing/testing-api-func.js":
/*!*************************************************!*\
  !*** ./application/testing/testing-api-func.js ***!
  \*************************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_0__);\n\r\n\r\nconst baseUrl = 'http://www.json-generator.com/api/json/get'\r\n\r\n\r\nconst API = {\r\n  getRandomUsers: () => {\r\n    return axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(`${baseUrl}/cfEhMBpvci?indent=2`)\r\n      .then( data => {\r\n        return data.data;\r\n      })\r\n  }\r\n\r\n}\r\n\r\n/* harmony default export */ __webpack_exports__[\"default\"] = (API);\r\n\n\n//# sourceURL=webpack:///./application/testing/testing-api-func.js?");

/***/ }),

/***/ "./application/testing/testing-func.js":
/*!*********************************************!*\
  !*** ./application/testing/testing-func.js ***!
  \*********************************************/
/*! exports provided: default */
